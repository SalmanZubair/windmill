...
<script
	...
	<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD_Ssn6MIgQigUX5qfTz2jVM90-koFQlRg&callback=initMap"></script>
  ...
  <nav class="navbar navbar-default top-fixed">
		<!-- Prolim Image -->
		<a class="navbar-brand" href="https://www.prolim.com/"> <img
			src="${pageContext.request.contextPath}/resources/images/prolim.png"
