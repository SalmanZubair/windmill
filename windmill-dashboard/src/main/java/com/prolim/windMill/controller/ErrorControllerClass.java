 ...
 * 
 * @Controller public class ErrorControllerClass implements ErrorController {
 * 
 ...
 * "resources/error/error-404"; } else if (statusCode ==
 * HttpStatus.INTERNAL_SERVER_ERROR.value()) { return
 * "resources/error/error-500"; } } return "error"; }
 * 
